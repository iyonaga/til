package com.example.iyonaga.mycountdowntimer
...
class MainActivity : AppCompatActivity() {
    ...
    inner class MyCountDownTimer(millisInFuture: Long, countDonwInterval: Long) : CountDownTimer(millisInFuture, countDonwInterval) {
        var isRunning = false
