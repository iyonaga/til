...
import MyAsciiArt from '../lib/my-ascii-art';
  ...
  describe('when the my-ascii-art:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let myAsciiArtElement = workspaceElement.querySelector('.my-ascii-art');
        expect(myAsciiArtElement).toExist();

        let myAsciiArtPanel = atom.workspace.panelForItem(myAsciiArtElement);
